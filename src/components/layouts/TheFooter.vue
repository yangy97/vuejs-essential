...
export default {
  ...
  data() {
    return {
      description: '杨玉印的第一个Vue项目',
      contacts: [
        {
          icon: 'envelope',
          title: '反馈问题',
          link: 'mailto:y1597355434@gmail.com'
        },
        {
          icon: 'weibo',
          title: '站长微博',
          link: 'https://weibo.com/277119014/home?wvr=5'
        },
        {
          icon: 'weixin',
          title: '加我微信',
      ...
      designer: `
        <span style="font-size:0.9em">Designed by
          ...
          <a href="https://yangy97.top/mylovecps/lovecps.html"target="_blank"style="color:inherit">Yangyu</a>
        </span>
      `,
      sponsor: {
        title: '赞助商',
